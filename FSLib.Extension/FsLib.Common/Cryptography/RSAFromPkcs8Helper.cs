...
namespace System.Cryptography
{
    ...
    /// </summary>
    public class RSAFromPkcs8Helper
    {
        /// <summary>
        /// 签名
        /// </summary>
        ...
        public static string Signature(string content, string privateKey, string charset = "utf-8", string signType = "MD5")
        {
        ...
        public static bool Verify(string content, string signedString, string publicKey, string charset = "utf-8", string signType = "MD5")
        {
            bool result = false;
        ...
        /// <param name="charset">编码格式</param>
        /// <returns>明文</returns>
        public static string DecryptData(string resData, string privateKey, string charset = "utf-8")
        {
