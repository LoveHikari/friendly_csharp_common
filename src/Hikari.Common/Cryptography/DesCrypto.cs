...
namespace Hikari.Common.Cryptography
{
    ...
    /// DES加解密
    /// </summary>
    public class DesCrypto : CryptoBase
    {
        ...
        public DesCrypto(string key, string iv = "", CipherMode mode = CipherMode.ECB, PaddingMode padding = PaddingMode.PKCS7, string encoding = "utf-8") : base(encoding)
        {
        ...
        /// <param name="padding"></param>
        /// <param name="encoding"></param>
        public DesCrypto(byte[] key, byte[]? iv = null, CipherMode mode = CipherMode.ECB, PaddingMode padding = PaddingMode.PKCS7, string encoding = "utf-8"): base(encoding)
        {
            _key = key;
            _iv = iv;
            _mode = mode;
