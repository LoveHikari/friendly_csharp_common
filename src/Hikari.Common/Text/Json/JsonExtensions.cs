...
namespace Hikari.Common.Text.Json
{
    ...
    {
        /// <summary>
        /// <see cref="System.Text.Json.JsonSerializerOptions"/> 扩展
        /// </summary>
        /// <param name="source">要解析的 JSON 文本</param>
        extension(in JsonElement.ArrayEnumerator source)
        {
            /// <summary>
            ...
            public List<TValue?> Deserialize<TValue>(JsonSerializerOptions? options = null) where TValue : class
            {
        ...
        extension(JsonSerializerOptions source)
        {
            /// <summary>
            ...
            public void SetIgnoreCondition(JsonIgnoreCondition condition)
            {
