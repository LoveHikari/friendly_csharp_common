...
namespace Hikari.Common.Hardware.Retrieval
{
    ...
    internal class OSXHardwareInfoRetrieval : HardwareInfoRetrievalBase, IHardwareInfo
    {
        [DllImport("libc")]
...
Audio:
    Devices:
        ...
        public List<VideoControllerInfo> GetVideoControllerList()
        {
            ...
            VideoControllerInfo? videoController = null;
            ...
            StartProcess("system_profiler", "SPDisplaysDataType",
                standardOutput =>
                {
                    ...
                    if (spaceCount == 4)
                    {
                        ...
                        videoController = new VideoControllerInfo()
                        {
                            Caption = name,
                            Description = name,
                            Name = name
